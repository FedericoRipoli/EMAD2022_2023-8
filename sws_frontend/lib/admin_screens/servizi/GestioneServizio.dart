  ...
  Future<bool> load() async {
        ...
        return DropdownMenuItem<String>(
          ...
          child: StatefulBuilder(
            builder: (context, menuSetState){
              ...
              return InkWell(
                onTap:(){
                  _isSelected ? areeValues.remove(item.id):areeValues.add(item.id!);
                  setState(() {
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      _isSelected?const Icon(Icons.check_box_outlined):const Icon(Icons.check_box_outline_blank_outlined),
    ...
    if (servizio != null) {
      ...
      if(servizio!.contatto!=null){
        sitoWebController.text = servizio!.contatto!.sitoWeb!=null?servizio!.contatto!.sitoWeb!:"";
        telefonoController.text = servizio!.contatto!.telefono!=null?servizio!.contatto!.telefono!:"";
        emailController.text = servizio!.contatto!.email!=null?servizio!.contatto!.email!:"";
      }
    }
    setState(() {
      loaded = true;
                                ...
                                selectedItemBuilder: (context) {
                                  return aree!.map(
                                      ...
                                      return Container(
                                        ...
                                        padding: const EdgeInsets.symmetric(horizontal: 16.0),
                                        child: Text(
                                          aree!.where((element) =>areeValues.contains(element.id!)).map((e) => e.nome)
                                          .join(', '),
